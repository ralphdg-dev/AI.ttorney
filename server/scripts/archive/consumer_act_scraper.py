...
def scrape_consumer_act(url):
    ...
    logger.info("Fetching Consumer Act content...")
...
def display_summary(data):
    ...
    law = data['law']
    logger.info(f"**Law:** {law['name']} ({law['date']})")
    ...
    for topic, count in stats['by_topic'].items():
        ...
        for article in sample_articles:
            logger.info(f"    - Article {article['number']}: {article['title'][:50]}...")

if __name__ == "__main__":
    logger.info("CONSUMER ACT SCRAPER")
    logger.info("Republic Act No. 7394")
    logger.info("=" * 35)
    ...
    logger.info("**CONSUMER ACT SCRAPING COMPLETE!**")
    logger.info("Files generated:")
    logger.info("  • consumer_act.json - Clean structured data")
    logger.info("  • consumer_act.md - Readable documentation")
    logger.info(f"Source: {CONSUMER_ACT_URL}")
