    ...
    try:
        ...
        if is_conversation_context_question(request.question):
            ...
            if past_conversations_summary:
                ...
                if language == "tagalog":
                    context_response = (
                        "Ako si Ai.ttorney, ang inyong advanced legal research assistant para sa Philippine jurisprudence! ⚖\n\n"
                    ...
                    context_response = (
                        "I'm Ai.ttorney, your advanced legal research assistant for Philippine jurisprudence! ⚖\n\n"
