        ...
        {messages.length === 0 ? (
          isLoadingConversation ? (
            ...
            >
              ...
              <Text
                style={[
                  tw`mb-2 font-bold text-center`,
                  { color: Colors.text.primary, fontSize: 20, lineHeight: 28 },
                ]}
              >
                {greeting}
              </Text>
              ...
              <Text
                style={[
                  tw`px-4 mb-10 text-center`,
                  { color: Colors.text.secondary, fontSize: 14, lineHeight: 20, maxWidth: 400 },
                ]}
              >
