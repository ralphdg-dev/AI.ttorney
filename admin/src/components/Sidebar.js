...
const Sidebar = ({ activeItem }) => {
  ...
  const getRouteForItem = (itemId) => {
    switch (itemId) {
      case "dashboard":
        return "/dashboard";
      case "manage-legal-seekers":
        return "/users/legal-seekers";
      case "manage-lawyers":
        return "/users/lawyers";
      case "lawyer-applications":
        return "/users/lawyer-applications";
      ...
      case "manage-legal-articles":
        return "/legal-resources/legal-articles";
      case "manage-topics-threads":
        return "/forum/topics-threads";
      case "reported-posts":
        return "/forum/reported-posts";
      case "reported-replies":
        return "/forum/reported-replies";
      case "ban-restrict-users":
        return "/appeals/ban-restrict-users";
      case "manage-appeals":
        return "/appeals/manage-appeals";
